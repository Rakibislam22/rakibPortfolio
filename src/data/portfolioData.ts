  ...
  competitiveProgramming: [
    {
      ...
      name: "LeetCode",
      username: "rakib2004",
      profileUrl: "https://leetcode.com/u/rakib2004/",
      problemsSolved: 150,
      rank: "Top 15%",
      badge: "Medium",
      achievements: [
        "Solved 150+ algorithmic problems",
        "Active streak: 30 days continuous problem solving",
        "Contest rating: 1500+"
      ]
    },
    {
      ...
      name: "Codeforces",
      username: "rakib2004",
      profileUrl: "https://codeforces.com/profile/rakib2004",
      problemsSolved: 200,
      rank: "newbie",
      badge: "newbie",
      achievements: [
        "Participated in 50+ international contests",
        "Max rating: 1400+",
    ...
    },
    {
      ...
      name: "HackerRank",
      username: "rakib2004",
      profileUrl: "https://www.hackerrank.com/profile/rakib2004",
      problemsSolved: 100,
      rank: "5 Stars",
      badge: "Expert",
      achievements: [
    ...
    },
    {
      ...
      name: "CodeChef",
      username: "rakib2004",
      profileUrl: "https://www.codechef.com/users/rakib2004",
      problemsSolved: 120,
      rank: "3 Stars",
      badge: "Intermediate",
      achievements: [
  ...
  certifications: [
    {
      ...
      issuer: "Coursera",
      date: "2024",
      credentialId: "CERT-MERN-2024",
      description: "Comprehensive program covering MongoDB, Express, React, Node.js, and RESTful API engineering.",
    ...
    },
    {
      ...
      issuer: "freeCodeCamp",
      date: "2023",
      credentialId: "FCC-JS-DSA",
      description: "Mastered core JavaScript algorithms, algorithmic complexity, data structures, and problem-solving.",
    ...
    },
    {
      ...
      issuer: "Udemy",
      date: "2023",
      credentialId: "UDEMY-REACT-GUIDE",
      description: "Deep dive into React hooks, custom state providers, performance memoization, and Next.js.",
    ...
    },
    {
      ...
      description: "Foundations of cloud computing, EC2 architectures, S3 storage, and serverless compute.",
      skills: ["AWS", "Cloud Computing", "EC2", "S3", "Serverless"]
    }
  ],
  testimonials: [
    {
      quote: "Working with Rakib was seamless from day one. Not only did he deliver a full-stack solution ahead of schedule, but he also communicated clearly throughout the project. It's rare to find a developer who understands both the tech and the business side so well.",
      name: "Alex Johnson",
    ...
    {
      quote: "From architecture to deployment, Rakib owned the entire stack with confidence and creativity. The final product is fast, reliable, and looks incredible. I wouldn't hesitate to work with him again.",
      name: "David Wilson",
